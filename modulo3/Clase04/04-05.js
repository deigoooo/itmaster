const nombres = ["Alejandro","Damián","Laura","Guadalupe","Marcela","Ana","Carolina","Andrea","Verónica","Alejandra","María","Carlos","José","Alberto","Mario"];
...
function buscar(){
    ...
    // Verificamos si el usuario escribió algo o el input de búsqueda está vacío
    if(busqueda.length >0){
        // Recorremos todos los nombres del array
        for(let nombre of nombres){ 
            // Comparamos cada nombre del array en minúscula con el nombre en minúsculas que escribió el usuario
