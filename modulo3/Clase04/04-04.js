...
function buscar(){
    ...
    if(encontrado){
        respuesta.innerHTML = `<strong class="exito">El texto ${busqueda} se ha encontrado en la lista</strong>`;
    } else{
        respuesta.innerHTML = `<strong class="error">El texto ${busqueda} NO se ha encontrado en la lista</strong>`;
    }
